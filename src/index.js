...
function Authz(string) {
  this.string = string;
}

Authz.prototype.toString = function() {
  return "" + this.string;
};
 ...
 */
Authz.prototype.getAccessToken = function() {
 ...
 */
 Authz.prototype.provision = function(accessToken, data) {
 ...
 */
 Authz.prototype.getPermissions = function(accessToken) {
 ...
 */
 Authz.prototype.createPermission = function(accessToken, existingPermissions, application, permission) {
 ...
 */
 Authz.prototype.getRoles = function(accessToken) {
 ...
 */
 Authz.prototype.createRole = function(accessToken, existingRoles, application, role) {
 ...
 */
 Authz.prototype.addRolePermissions = function(accessToken, existingRoles, existingPermissions, application, role) {
 ...
 */
 Authz.prototype.getGroups = function(accessToken) {
 ...
 */
Authz.prototype.createGroup = function(accessToken, existingGroups, group) {
 ...
 */
 Authz.prototype.createNestedGroups = function(accessToken, existingGroups, group) {
